-- ==========================================
-- Hospital Management Portal Database Setup (Cloud Server Version)
-- Use this version for SmarterASP.NET Database
-- ==========================================

-- NOTE: CREATE DATABASE and USE statements are commented out 
-- because shared hosting accounts do not have server admin permissions.
-- Just run this script directly on your db_acaefb_hospital database.
...
PRINT 'HospitalManagementDB schema created successfully on Cloud Server!';
